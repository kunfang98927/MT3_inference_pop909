# -*- coding: utf-8 -*-
"""“Music Transcription with Transformers”的副本

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tifgCJRcRcvFYfttGp5Ygb6cS0q5n3lQ
"""
...
output_dir = 'output_midi1'

input_path = '/content/input_audio'
...
for root,dirs,audio_files in os.walk(input_path):
  for file in audio_files:
    path = root+'/'+file
    count+=1
    print(count, '  ',path)

    audio, unused_sr = librosa.load(path, sr=SAMPLE_RATE, mono=True)
    est_ns = inference_model(audio)
    note_seq.play_sequence(est_ns, synth=note_seq.fluidsynth, sample_rate=SAMPLE_RATE, sf2_path=SF2_PATH)
    new_name = file.replace('.mp3','.mid')
    note_seq.sequence_proto_to_midi_file(est_ns, f'{output_dir}/{new_name}')
    files.download(f'{output_dir}/{new_name}')